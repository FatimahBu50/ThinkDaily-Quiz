...
public class DailyQuizPage extends JFrame {
    ...
    public DailyQuizPage(int userId) {
        ...
        top.setOpaque(false);
        // small padding so text does not touch rounded corners
        ...
        // border to pull content in a bit and visually center
    ...
    private class AnswerButton extends JPanel {
        ...
        public AnswerButton(Answer ans) {
            ...
            setLayout(new BorderLayout());
            // medium sized rectangle, centered
...
// ==============================================================
    ...
    if (queries != null) {
        for (Question qq : questions) {
            ...
            sessionPoints += pts;
            try {
                queries.saveUserResponse(userId, qq.questionId, sel, isCorrect, pts, new java.sql.Timestamp(System.currentTimeMillis()), "DAILY", null);
            } catch (SQLException ex) {
                ex.printStackTrace();
            }
        }
    ...
    q1.correctAnswerId = 102;   // ✅ correct
    ...
    q2.correctAnswerId = 201;   // ✅ correct
    ...
    q3.answers.add(new Answer(303, "60"));   // 🔧 small fix: make this 303 not 302
    q3.correctAnswerId = 303;               // ✅ correct
